...
<template>
  <div class="auth">
    ...
    <aside class="auth__brand">
      <div class="brand-top">
        <span class="logo">
          <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#16b8a6" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3 17l5-6 4 3 4-6 5 4" /></svg>
          SahamScope
        </span>
